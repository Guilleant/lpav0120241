...
@section('content')
    <div class="card border-success mb-3">
        <div class="card-header bg-transparent border-success d-flex justify-content-between">
            ...
            <a class="btn btn-primary" href="{{ route('lenguajes.create') }}">
                    ...
                    @foreach ($lenguajes as $item)
                        <tr>
                            ...
                            <td class="d-flex gap-3">
                                <a class="btn btn-warning btn-sm" href="{{ route('lenguajes.edit', $item->id) }}">
                                    <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                </a>


                                <form action="{{ route('lenguajes.destroy', $item->id) }}" method="POST" id="formulario">
                                    @csrf
                                    @method('DELETE')
